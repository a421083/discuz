...
jq(window).scroll(function(){
	...
	var scrolltop = jq(window).scrollTop() + 120;
	if(scrolltop < index1){
		indexnum = 0;
...
jq(function(){
	jq(".in_banner").hover(function(){
		jq(".slide_left",this).stop().animate({"left":"0"},300)
		jq(".slide_right",this).stop().animate({"right":"0"},300)
	},function(){
		jq(".slide_left",this).stop().animate({"left":"-50px"},300)
		jq(".slide_right",this).stop().animate({"right":"-50px"},300)
	})
})
